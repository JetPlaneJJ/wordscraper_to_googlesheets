...
total = c_p + c_div
irrelevant_words = ["it","window.foxstrike","window.foxstrike.cmd","–","ampvideo_youtubethe","coveragekeyboard_arrow_up","...ampvideo_youtubethe","agobookmark_bordersharemore_vert","agobookmark_bordersharemore_vertview"," ","","is","as","from","of","to","the","for","a","and","on","in","this","are","at","be","by","has","were","will","with","they"]
